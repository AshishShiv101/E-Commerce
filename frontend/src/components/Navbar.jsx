...
const Navbar = () => {
  ...
  return (
    <header className='fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-teal-800'>
          ...
          <nav className='flex flex-wrap items-center gap-4'>
            ...
            {user ? (
              ...
              <>
                <Link
                  to={"/signup"}
                  className='bg-teal-600 hover:bg-teal-700 text-white py-2 px-4 
									rounded-md flex items-center transition duration-300 ease-in-out'
                >
